...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '静水流年', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '静水流年的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vochat.eu.org', // 网站地址
